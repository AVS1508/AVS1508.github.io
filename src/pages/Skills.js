                ...
                <div className="center inner-structure" style={{ flexDirection: "column" }}>
                    ...
                    <Container fluid style={{ maxWidth: "90vw", textAlign: "center" }}>
                        <Row className="justify-content-center" style={{ alignItems: "center" }}>
                            ...
                            />
                            <SkillCard title="Problem Solving (Basic)" logo="hackerrank" color="#2EC866" link="https://www.hackerrank.com/certificates/e8eb84528825" />
                            <SkillCard title="Python (Basic)" logo="hackerrank" color="#2EC866" link="https://www.hackerrank.com/certificates/af328ac62ad0" />
                            <SkillCard title="Python (Intermediate)" logo="hackerrank" color="#2EC866" link="https://www.hackerrank.com/certificates/ebf245c0eb27" />
                            <SkillCard title="Java (Basic)" logo="hackerrank" color="#2EC866" link="https://www.hackerrank.com/certificates/6a630c2133d9" />
                            <SkillCard title="Java (Intermediate)" logo="hackerrank" color="#2EC866" link="https://www.hackerrank.com/certificates/dfdcfe8f8ee4" />
                            <SkillCard title="JavaScript (Basic)" logo="hackerrank" color="#2EC866" link="https://www.hackerrank.com/certificates/7af2e8e3f0e3" />
                            <SkillCard title="C++ (Basic)" logo="hackerrank" color="#2EC866" link="https://www.hackerrank.com/certificates/d70364be6715" />
                            <SkillCard
