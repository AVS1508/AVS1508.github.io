...
const Home = () => {
    return (
        <Container fluid className={styles.container} style={{ background: `url(${HomeBackground})` }}>
            ...
            <Row>
                <Col><span className={`${styles.textWhite} ${styles.headingOne}`}>Aditya Vikram Singh</span></Col>
            </Row>
            <Row>
                <Col><span className={`${styles.textWhite} ${styles.headingThree}`}>Software Engineer, Full-Stack Developer, College Student</span></Col>
            </Row>
            <Row>
                <Col><a href="https://www.github.com/AVS1508" target="_blank_"><FaGithubSquare className={styles.icon} /></a></Col>
                <Col><a href="https://www.behance.net/AVS1508" target="_blank_"><FaBehanceSquare className={styles.icon} /></a></Col>
                <Col><a href="https://www.linkedin.com/in/avs1508" target="_blank_"><FaLinkedin className={styles.icon} /></a></Col>
